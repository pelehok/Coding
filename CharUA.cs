...
namespace CeazarCode
{
    static class CharUA
    {
        private static List<char> UA_ABC = new List<char>()
        ...
        private static List<char> UA_LoudLetter = new List<char>()
            { 'о','а','и', 'і', 'у' };

        public static int loudLetterLenght = UA_LoudLetter.Count;

        public static int ABCLength = UA_ABC.Count;

        public static int GetNumber(char inputChar)
        {
            return UA_ABC.IndexOf(inputChar);
        }

        public static Char GetChar(int inputInt)
        {
            return UA_ABC[inputInt];
        }
